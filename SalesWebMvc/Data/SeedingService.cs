    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                //STATUSRECORDS
                _context.Database.ExecuteSqlCommand("SET IDENTITY_INSERT dbo.SalesRecords ON");
                ...
                _context.Database.ExecuteSqlCommand("SET IDENTITY_INSERT dbo.SalesRecords OFF");
